...
import { FITBIT_AUTHORIZE_URL, FITBIT_SCOPES, FITBIT_OAUTH_COOKIE } from '@/lib/fitbit/constants'
...
export async function GET(req: NextRequest) {
  ...
  const authorizeUrl = new URL(FITBIT_AUTHORIZE_URL)
  authorizeUrl.searchParams.set('client_id', clientId)
  authorizeUrl.searchParams.set('response_type', 'code')
  authorizeUrl.searchParams.set('scope', FITBIT_SCOPES)
